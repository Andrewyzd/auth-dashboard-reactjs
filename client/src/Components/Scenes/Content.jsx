...
import GeographyChart from "../Features/GeographyChart";
        ...
        <Box m="20px">
            ...
            >
                ...
                >
                    ...
                    {mockTransactions.map((transaction, i) => (
                        <Box
                            ...
                            p="15px"
                        >
                            {/* The transaction name and the transaction user's name*/}
                            <Box>
                                <Typography
                                color={colors.greenAccent[500]}
                                variant="h5"
                ...
                >
                    ...
                    {/* Progress Cricle chart and message*/}
                    <Box
                        display="flex"
                ...
                <Box
                    ...
                    padding="30px"
                >
                    {/* Geography Based Traffic Header */}
                    <Typography
                        variant="h5"
                        fontWeight="600"
